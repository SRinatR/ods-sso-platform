...
class IdentityServiceTest {
    ...
    fun `registration creates minimal account and does not disclose duplicate email`() {
        ...
        assertThat(created.firstValue.firstNameCyrillic).isNull()
        assertThat(created.firstValue.lastNameCyrillic).isNull()
        assertThat(created.firstValue.patronymicCyrillic).isNull()
        assertThat(created.firstValue.firstNameLatin).isNull()
        assertThat(created.firstValue.lastNameLatin).isNull()
        assertThat(created.firstValue.patronymicLatin).isNull()
